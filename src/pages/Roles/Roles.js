...
const Roles = () => {
  ...
  const pageOptions = {
    ...
    totalSize: roles.length, // replace later with size(users),
    custom: true
  }
  const defaultSorted = [
    {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      permissions: Yup.string().email("Email is not valid!").required("Email is required"),
    }),
    onSubmit: (values) => {
      if (isEdit) {
        //edit role
                                              ...
                                              <Col xs={12}>
                                                <div className="mb-3">
                                                  ...
                                                  {validation.touched.full_name && validation.errors.full_name ? (
                                                    <FormFeedback
                                                      type="invalid">{validation.errors.full_name}</FormFeedback>
                                                  ) : null}
                                                </div>
                                                <div className="mb-3">
